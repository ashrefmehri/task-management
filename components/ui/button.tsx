  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:bg-neutral-100 disabled:from-neutral-100  disabled:to-neutral-100 disabled:text-neutral-100 border border-neutral-200 shadow-sm ",
  {
    variants: {
      variant: {
        ...
        teritary:"bg-blue-100 text-blue-600 hover:bg-blue-200 border-transparent shadow-none"
      },
      size: {
